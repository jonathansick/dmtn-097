...
%\caption{The atmospheric parameters needed to produce an atmospheric transmission curve from a radiative transfer simulation.   
%\label{fig:im1}
%}
%\end{figure}
